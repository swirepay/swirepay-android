...
enum CardEnum {
    ...
    AmericanExpress("Amex", R.drawable.ic_amex, "34, 37", "15"),
...
//    Dankort("Dankort", R.drawable.payment_ic_method, "5019", "16"),
    DinersClub("Diners", R.drawable.ic_diners_club, "300-305, 309, 36, 38, 39", "14"),
...
//    JCB("JCB", R.drawable.payment_ic_method, "3528-3589", "16-19"),
    Maestro("Maestro", R.drawable.ic_maestro, "5018, 5020, 5038, 5893, 6304, 6759, 6761, 6762, 6763", "16"),
...
//    VisaElectron("Visa Electron", R.drawable.payment_ic_method, "4026, 417500, 4508, 4844, 4913, 4917", "16"),
    Visa("Visa", R.drawable.ic_visa, "4", "16"),
    Rupay("Rupay", R.drawable.ic_rupay, "60, 65, 81, 82, 508", "16"),
