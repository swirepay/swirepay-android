...
public class SwirepayTextInputEditText extends TextInputEditText {
    ...
    public SwirepayTextInputEditText(@NonNull Context context) {
        this(context, null);
    }

    public SwirepayTextInputEditText(@NonNull Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public SwirepayTextInputEditText(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private TextWatcher getTextWatcher() {
        return new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                SwirepayTextInputEditText.this.afterTextChanged(s);
            }
        };
    }
