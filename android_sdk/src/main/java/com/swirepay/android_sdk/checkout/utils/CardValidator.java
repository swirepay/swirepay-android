...
public final class CardValidator {
    ...
    public static Card guessCard(String cardNumber) {
        ...
        return new Card("Empty", new ArrayList<>(), R.drawable.ic_card);
    }

    private static ArrayList<Integer> fetchPossibleLength(CardEnum cardEnum) {
